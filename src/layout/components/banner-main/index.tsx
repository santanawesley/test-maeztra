...
import { Img1Banner, Img1BannerMob } from "../../../assets";
import "./banner.scss";
...
const Banner = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      subTitle: "Confira os melhores looks para combinar com você nesse Verão",
      CTAText: "Conferir",
      imgUrl: "Img1Banner",
      id: 2,
    },
    {
      ...
      subTitle:
        "Confira os melhores looks para combinar com você nesse Inverno",
      CTAText: "Conferir",
      imgUrl: "Img1Banner",
      id: 3,
    },
    {
      ...
      subTitle:
        "Confira os melhores looks para combinar com você nessa Primavera",
      CTAText: "Conferir",
      imgUrl: "Img1Banner",
      id: 4,
    },
    {
      ...
      subTitle:
        "Confira os melhores looks para combinar com você nesse Ano Novo",
      CTAText: "Conferir",
      imgUrl: "Img1Banner",
      id: 5,
    },
        ...
        {data.map((item) => {
          return (
            <div key={item.id}>
              <div>
                <img
                  src={isMobile ? Img1BannerMob : Img1Banner}
                  alt="Imagem 1"
                  className="img-banner"
                />
                <h3 className="title-banner">{item.title}</h3>
                <p className="sub-title-banner">{item.subTitle}</p>
                <button className="button-cta-banner">{item.CTAText}</button>
              </div>
            </div>
          );
        })}
